#!/usr/bin/env python3
"""
Create full 4x4 comparison heatmap for 3-month windows version.
Shows IRL vs baselines with correct 3-month width future windows.
"""
...
lr_matrix = pd.read_csv(
    'importants/baseline_nova_3month_windows/logistic_regression/matrix_AUC_ROC.csv',
    index_col=0
)
rf_matrix = pd.read_csv(
    'importants/baseline_nova_3month_windows/random_forest/matrix_AUC_ROC.csv',
    index_col=0
)
...
plt.suptitle('IRL+LSTM vs Baselines: Full 4×4 Evaluation (3-Month Windows)',
             fontsize=16, fontweight='bold', y=0.995)
plt.tight_layout()

# Save figure
output_path = Path('importants/baseline_nova_3month_windows/comparison_heatmaps_full.png')
